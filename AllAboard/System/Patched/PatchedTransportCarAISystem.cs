    ...
    public partial class PatchedTransportCarAISystem : GameSystemBase
    {
        ...
        protected override void OnUpdate()
        {
            ...
            var jobHandle = new TransportCarTickJob
            {
                ...
                m_SpawnLocationData =
                    InternalCompilerInterface.GetComponentLookup<Game.Objects.SpawnLocation>(
                ...
                m_OwnerData =
                    InternalCompilerInterface.GetComponentLookup<Owner>(
                ...
                m_PrefabCarData =
                    InternalCompilerInterface.GetComponentLookup<CarData>(
                ...
                m_PrefabSpawnLocationData = InternalCompilerInterface.GetComponentLookup<SpawnLocationData>(
                ...
                m_PrisonerTransportRequestData = InternalCompilerInterface.GetComponentLookup<PrisonerTransportRequest>(
                    ...
                    ref CheckedStateRef),
                m_WaypointData =
                    InternalCompilerInterface.GetComponentLookup<Waypoint>(
                        ref __TypeHandle.__Game_Routes_Waypoint_RO_ComponentLookup, ref CheckedStateRef),
                m_ConnectedData =
                    InternalCompilerInterface.GetComponentLookup<Connected>(
                ...
                m_RouteLaneData =
                    InternalCompilerInterface.GetComponentLookup<RouteLane>(
                        ref __TypeHandle.__Game_Routes_RouteLane_RO_ComponentLookup, ref CheckedStateRef),
                m_RouteColorData =
                    InternalCompilerInterface.GetComponentLookup<Game.Routes.Color>(
                ...
                m_PrisonData =
                    InternalCompilerInterface.GetComponentLookup<Game.Buildings.Prison>(
            ...
            }.ScheduleParallel<TransportCarTickJob>(m_VehicleQuery, Dependency);
            var inputDeps = boardingData.ScheduleBoarding((SystemBase)this, m_CityStatisticsSystem,
                ...
                m_SimulationSystem.frameIndex, jobHandle);
        ...
        private struct TransportCarTickJob : IJobChunk
        {
                ...
                in v128 chunkEnabledMask)
            {
                ...
                var nativeArray3 = chunk.GetNativeArray<PathInformation>(ref m_PathInformationType);
                var nativeArray4 = chunk.GetNativeArray<PrefabRef>(ref m_PrefabRefType);
                var nativeArray5 = chunk.GetNativeArray<CurrentRoute>(ref m_CurrentRouteType);
                var nativeArray6 = chunk.GetNativeArray<CarCurrentLane>(ref m_CurrentLaneType);
                var nativeArray7 = chunk.GetNativeArray<Game.Vehicles.CargoTransport>(ref m_CargoTransportType);
                var nativeArray8 = chunk.GetNativeArray<Game.Vehicles.PublicTransport>(ref m_PublicTransportType);
                var nativeArray9 = chunk.GetNativeArray<Car>(ref m_CarType);
                var nativeArray10 = chunk.GetNativeArray<Target>(ref m_TargetType);
                var nativeArray11 = chunk.GetNativeArray<PathOwner>(ref m_PathOwnerType);
                var nativeArray12 = chunk.GetNativeArray<Odometer>(ref m_OdometerType);
                var bufferAccessor1 = chunk.GetBufferAccessor<CarNavigationLane>(ref m_CarNavigationLaneType);
                var bufferAccessor2 = chunk.GetBufferAccessor<Passenger>(ref m_PassengerType);
                var bufferAccessor3 = chunk.GetBufferAccessor<ServiceDispatch>(ref m_ServiceDispatchType);
                ...
                ref Odometer odometer)
            {
                ...
                if (!m_EntityLookup.Exists(target.m_Target) || VehicleUtils.PathfindFailed(pathOwner))
                {
                    ...
                    if (VehicleUtils.IsStuck(pathOwner) ||
                        ...
                        (PublicTransportFlags)0)
                    {
                        m_CommandBuffer.AddComponent<Deleted>(jobIndex, vehicleEntity, new Deleted());
                        return;
                    }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (!StartBoarding(jobIndex, vehicleEntity, currentRoute, prefabRef, ref cargoTransport,
                                    ref publicTransport, ref target, component2))
                            {
                                    ...
                                    (PublicTransportFlags)0)
                                {
                                    if (!SelectNextDispatch(jobIndex, vehicleEntity, currentRoute, navigationLanes,
                                            ...
                                            ref currentLane, ref pathOwner, ref target, component1))
                                        ReturnToDepot(jobIndex, vehicleEntity, currentRoute, owner, serviceDispatches,
                                            ref cargoTransport, ref publicTransport, ref car, ref pathOwner,
                                            ref target);
                                }
                ...
                if ((((cargoTransport.m_State & CargoTransportFlags.Boarding) != (CargoTransportFlags)0 ? 0 :
                         (publicTransport.m_State & PublicTransportFlags.Boarding) == (PublicTransportFlags)0 ? 1 : 0) |
                     (flag3 ? 1 : 0)) == 0)
                    return;
                if (VehicleUtils.RequireNewPath(pathOwner))
                {
                    FindNewPath(vehicleEntity, prefabRef, skipWaypoint, target1, ref currentLane, ref cargoTransport,
                ...
                DynamicBuffer<CarNavigationLane> navigationLanes)
            {
                ...
                VehicleUtils.ValidateParkingSpace(entity, ref random, ref currentLane, ref pathOwner, navigationLanes,
                    pathElement, ref m_ParkedCarData, ref blockerData, ref m_CurveData, ref m_UnspawnedData,
                ...
                ref CarCurrentLane currentLane)
            {
                ...
                m_CommandBuffer.SetComponent<ParkedCar>(jobIndex, entity,
                ...
                ref Target target)
            {
                ...
                var parameters = new PathfindParameters
                {
                    ...
                    m_ParkingTarget = VehicleUtils.GetParkingSource(vehicleEntity, currentLane, ref m_ParkingLaneData,
                ...
                ref Game.Vehicles.CargoTransport cargoTransport)
            {
                ...
                {
                    if (((int)m_SimulationFrameIndex & ((int)math.max(64U /*0x40*/, 16U /*0x10*/) - 1)) != 1)
                        return;
                    ...
                    m_CommandBuffer.SetComponent<EvacuationRequest>(jobIndex, entity1,
                        new EvacuationRequest(entity, 1f));
                    m_CommandBuffer.SetComponent<RequestGroup>(jobIndex, entity1, new RequestGroup(4U));
                }
                else if ((publicTransport.m_State & PublicTransportFlags.PrisonerTransport) != (PublicTransportFlags)0)
                {
                    if (((int)m_SimulationFrameIndex & ((int)math.max(256U /*0x0100*/, 16U /*0x10*/) - 1)) != 1)
                        return;
                    var entity2 = m_CommandBuffer.CreateEntity(jobIndex, m_PrisonerTransportRequestArchetype);
                    m_CommandBuffer.SetComponent<ServiceRequest>(jobIndex, entity2, new ServiceRequest(true));
                    m_CommandBuffer.SetComponent<PrisonerTransportRequest>(jobIndex, entity2,
                        new PrisonerTransportRequest(entity, 1));
                    m_CommandBuffer.SetComponent<RequestGroup>(jobIndex, entity2, new RequestGroup(16U /*0x10*/));
                }
                else
                {
                    if (((int)m_SimulationFrameIndex & ((int)math.max(256U /*0x0100*/, 16U /*0x10*/) - 1)) != 1)
                    ...
                    m_CommandBuffer.SetComponent<ServiceRequest>(jobIndex, entity3, new ServiceRequest(true));
                    m_CommandBuffer.SetComponent<TransportVehicleRequest>(jobIndex, entity3,
                        new TransportVehicleRequest(entity, 1f));
                    m_CommandBuffer.SetComponent<RequestGroup>(jobIndex, entity3, new RequestGroup(8U));
                }
            }
                     ...
                     publicTransport.m_RequestCount = math.max(0, publicTransport.m_RequestCount - 1))
                {
                    ...
                    else
                    {
                        if (m_TransportVehicleRequestData.HasComponent(request))
                        {
                            ...
                            m_CommandBuffer.SetComponent<HandleRequest>(jobIndex, entity2,
                        ...
                        else
                        {
                            ...
                            m_CommandBuffer.SetComponent<HandleRequest>(jobIndex, entity3,
                        ...
                        if (m_ServiceRequestData.HasComponent(publicTransport.m_TargetRequest))
                        {
                            ...
                            m_CommandBuffer.SetComponent<HandleRequest>(jobIndex, entity4,
                        ...
                        if (m_ServiceRequestData.HasComponent(cargoTransport.m_TargetRequest))
                        {
                            ...
                            m_CommandBuffer.SetComponent<HandleRequest>(jobIndex, entity5,
                ...
                bool isCargoVehicle)
            {
                    ...
                    (PublicTransportFlags)0)
                {
                    ...
                    publicTransport.m_DepartureFrame =
                        (publicTransport.m_State & PublicTransportFlags.Returning) == (PublicTransportFlags)0
                            ? m_SimulationFrameIndex + 4096U /*0x1000*/
                            : m_SimulationFrameIndex + 64U /*0x40*/;
        ...
        private struct TypeHandle
        {
            ...
            public void __AssignHandles(ref SystemState state)
            {
                ...
                __Game_Buildings_Prison_RO_ComponentLookup = state.GetComponentLookup<Game.Buildings.Prison>(true);
                __Game_Buildings_EmergencyShelter_RO_ComponentLookup =
                ...
                __Game_Net_CarLane_RO_ComponentLookup = state.GetComponentLookup<Game.Net.CarLane>(true);
                __Game_Net_SlaveLane_RO_ComponentLookup = state.GetComponentLookup<SlaveLane>(true);
                __Game_Net_ParkingLane_RO_ComponentLookup = state.GetComponentLookup<Game.Net.ParkingLane>(true);
                __Game_Net_GarageLane_RO_ComponentLookup = state.GetComponentLookup<GarageLane>(true);
                __Game_Net_ConnectionLane_RO_ComponentLookup = state.GetComponentLookup<Game.Net.ConnectionLane>(true);
